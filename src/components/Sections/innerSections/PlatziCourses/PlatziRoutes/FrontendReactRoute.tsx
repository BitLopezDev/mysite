...
const FrontendReactRoute = () => {
  const description =
    "En esta ruta profundizo mi conocimiento sobre REACT.JS: aprendo en profundidad sobre el estado de React, los hooks y completo mi conocimiento sobre la librería de Meta.";
  /* 
