  ...
  return (
    <center>
      <center>
        ...
        <h5>
          Haga click en los vendors de la leyenda para mostrar/ocultar sus
          resultados
        </h5>
      </center>
      {/* */}
      ...
      <Layout nav={false}>
        <center>
          <h1 className="antigradienttext">Las amenazas en el mundo </h1>
          <br />
        ...
        <Hcard
          imgurl={MSPWhiteICO}
          pcontent={
            "Según el Reporte de estado de Ciberseguridad del instituto Ponemon, 66% de las pymes ha expermentado un cyberataque en los últimos 12 meses, y el 45% afirma que sus medidas de seguridad no son efectivas para mitigar los ataques.  "
          }
        />{" "}
        <br />
        <Hcard
          imgurl={MSPWhiteICO}
          pcontent={
            "Según Accenture's Cost of Cybercrime Study el 43% de los ciberataques tienen como objetivo a los pequeños negocios, de los que solamente el 14% está preparado para defenderse.   "
          }
        />{" "}
        <br />
      </Layout>
