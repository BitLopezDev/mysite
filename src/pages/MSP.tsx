    ...
    return (
        ...
        <React.Fragment>
            ...
            <center style={{paddingTop:35}} >
                    <h1 className="antigradienttext">Nuestros<i> vendors </i>de preferencia</h1>
                    <br />
            ...
            <center>
                    ...
                    <br />
                    <h4>Reconocimiento AV-Comparatives</h4>
                    <br />
                </center>
                {/* */}
                <br />
                ...
                <div className="card-img-top d-flex align-items-center ">
                    <div>
                        <Image className="img-fluid" src={Object.entries(Bitdefender)[0].slice(1)} alt="Bitdefender for Home" style={{padding:10}} />
                    </div>

                    <p className="card-text"><strong>Bitdefender Endpoint Security Tools</strong> lidera la protección de Endpoints contra ataques de Día Cero (Zero-day attack) y, aunque el gráfico no lo señale, protección contra malwares más extendidos en Endpoints. Por esta razón es nuestra herramienta preferida para este tipo de dispositivos; la historia nos da la razón.
                    </p>
                </div>
